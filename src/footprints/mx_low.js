...
module.exports = {
  ...
  body: p => {
    const standard = `
      ...
      ${'' /* footprint reference */}
      (fp_text reference "${p.ref}" (at 0 -7.14375 180) ${p.ref_hide} (layer F.SilkS) (effects (font (size 1 1) (thickness 0.2))))
    ...
    function pins(def_neg, def_pos, def_side) {
      if(p.param.hotswap) {
        return `
        ${''/* pins */}
        (pad 1 thru_hole circle (at 0 6.05 180) (size 2 2) (drill 1.2) (layers *.Cu *.Mask) ${p.net.from.str})
        (pad 2 thru_hole circle (at 4.13 3.3 41.9) (size 2 2) (drill 1.2) (layers *.Cu *.Mask) ${p.net.from.str})
      `
      } else {
          return `
            ${''/* pins */}
